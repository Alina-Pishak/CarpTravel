        ...
        >
          ...
          {name !== "message" ? (
            ...
            <textarea
              id={name}
              {...register(name)}
              className=" font-extralight text-[13px] leading-[1.8] px-2 w-full bg-bgInputs resize-none	mb-4 placeholder:opacity-20 h-[196px] transition-colors hover:bg-bgHoverInputs focus:bg-bgHoverInputs"
            />
          )}
          {name !== "message" && (
